...
/***/ function(module, exports, __webpack_require__) {
	...
	var FormStore = (_class = function () {
	  ...
	  function FormStore(options, data) {
	    ...
	    _initDefineProp(this, 'dataChanges', _descriptor5, this);
	
	    this.dataServer = {};
	
	    _initDefineProp(this, 'data', _descriptor6, this);
	
	    _initDefineProp(this, 'dataErrors', _descriptor7, this);
	
	    _initDefineProp(this, 'saveNotification', _descriptor8, this);
	  ...
	  // changes that will be sent to server
	            ...
	            try {
	              var _ret = function () {
	                ...
	                if (store.options.server.set && (!store.options.idProperty || !store.options.server.create || store.data[store.options.idProperty])) {
	                  return {
	                    v: store.options.server.set(updates).then(function ($await_15) {
	                      response = $await_15;
	                  ...
	                  return {
	                    v: store.options.server.create(updates).then(function ($await_16) {
	                      response = $await_16;
	                      return $IfStatement_8.call(this);
	                    }.$asyncbind(_this2, $Try_2_Catch), $Try_2_Catch)
	                  };
	...
	}), _descriptor5 = _applyDecoratedDescriptor(_class.prototype, 'dataChanges', [_mobx.observable], {
	  enumerable: true,
	  initializer: function initializer() {
	    return (0, _mobx.asMap)();
	  }
	}), _descriptor6 = _applyDecoratedDescriptor(_class.prototype, 'data', [_mobx.observable], {
	  enumerable: true,
	  initializer: function initializer() {
	    return {};
	  }
	}), _descriptor7 = _applyDecoratedDescriptor(_class.prototype, 'dataErrors', [_mobx.observable], {
	  enumerable: true,
	  initializer: function initializer() {
	    return {};
	  }
	}), _descriptor8 = _applyDecoratedDescriptor(_class.prototype, 'saveNotification', [_mobx.observable], {
	  enumerable: true,
	  initializer: function initializer() {
