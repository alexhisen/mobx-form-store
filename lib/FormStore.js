...
/***/ (function(module, exports, __webpack_require__) {
	...
	function isSame(val1, val2) {
	  ...
	  return val1 == val2 || val1 instanceof Date && val2 instanceof Date && val1.valueOf() == val2.valueOf() || (Array.isArray(val1) || (0, _mobx.isObservableArray)(val1)) && (Array.isArray(val2) || (0, _mobx.isObservableArray)(val2)) && val1.toString() === val2.toString();
	...
	var FormStore = (_class = function () {
	  ...
	  _createClass(FormStore, [{
	    ...
	    value: function refresh() {
	      var refreshOptions = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
	      return new Promise(function ($return, $error) {
	        var allowIfMustCreate, ignoreMinRefreshInterval, store, now, past, result;
	        ...
	        return new Promise(function ($return, $error) {
	          ...
	          if (saveAll) {
	            ...
	            Object.keys(updates).forEach(function (property) {
	              ...
	              if ((0, _mobx.isObservableArray)(updates[property])) {
